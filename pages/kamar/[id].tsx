...
export default function detailKamar({ id }: { id: number }) {
        ...
        <>
            <div className="container mx-auto">
                ...
                <div className="w-full h-[600px] bg-slate-400 rounded-xl relative">
                    <Image src={data?.picture} className="rounded-xl" alt="Thumbnail Sekolah" layout="fill" objectFit="cover" placeholder="blur" // Optional blur-up while loading
                ...
                <div className="w-[95%] mx-auto h-[200px] rounded-md bg-white shadow-md relative z-10 -mt-20 p-20">
                    <div className="flex flex-row flex-wrap justify-between">
                        <div className="w-[80%]">
                            ...
                            <h4 className="text-xl text-slate-400">IDR {data?.price} / Malam</h4>
                        </div>
